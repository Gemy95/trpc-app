...
import { GetAllDepartmentsDto } from '../../modules/departments/dto/get-all-department.dto';
import { ACTIVE, EMPLOYEE_STATUS, IN_ACTIVE } from '../../modules/shoppex-employee/interface/status.enum';
