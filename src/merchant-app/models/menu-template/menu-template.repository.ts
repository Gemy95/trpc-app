...
// import { BaseRepository } from '../../menu-template/dto/create-menu-template.dto';
...
export class MenuTemplateRepository extends BaseRepository<MenuTemplate> {
  constructor(
    ...
    private readonly settingRepository: SettingRepository, // private readonly productService: ProductService,
  ) {
    super(nModel);
  }

  // async createOne(createMenuTemplateDto: CreateMenuTemplateDto) {
  //  const isMenuTemplateExists =
  //   await this.getOne(
  //     {
  ...
  //     const menuTemplateProductsIds = ele.menuTemplateProductsIds.map((ele)=> { return new mongoose.Types.ObjectId(ele) });
  //     return {
  //       ...productCategory,
