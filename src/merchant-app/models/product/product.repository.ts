...
import { IPrepareOrder, PRODUCT_APPROVED_STATUS } from './../../modules/common/constants/product';
...
export class ProductRepository extends BaseRepository<Product> {
  ...
  //   return this.nModel.countDocuments({
  //     categoriesIds: { $in: [productCategoryId] },
  //   });
  // }
  ...
  //   if (
  //     user?.type === 'MerchantEmployee' /*&& user['branches']?.length >= 1*/
  //   ) {
  //     const branchesIds =
  //       (await this.merchantEmployeeRepository.getOne({ _id: user?._id }))
  //         ?.branchesIds || [];
  ...
  //     delete Object.assign(generatedMatch, {
  //       'branches._id': generatedMatch['branches'],
  //     })['branches'];
  //   }
