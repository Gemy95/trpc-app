...
import { MERCHANT_REQUEST_TYPES } from '../../modules/common/constants/merchant';
...
export class ReviewRepository extends BaseRepository<Review> {
  ...
  //     (generatedMatchMerchant['merchantRequestType'] =
  //       generatedMatch['merchantRequestType']),
  ...
  //     {
  //       $project: {
  //         result: { $setUnion: ['$Merchant', '$Product', '$Branch'] },
  //       },
  //     },
  //     { $unwind: '$result' },
  ...
  //       $match:
  //         generatedMatchMerchant['merchantRequestType'] ==
  //         MERCHANT_REQUEST_TYPES.BANK_ACCOUNT
  //           ? {
