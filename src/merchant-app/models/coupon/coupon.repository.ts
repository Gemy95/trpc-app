...
// import { BaseRepository } from '../../coupon/dto/check-coupon.dto';
...
import { COUPON_STATUS } from './../../modules/common/constants/coupon.constants';
import { AMOUNT_TYPE } from './../../modules/common/constants/order.constants';
...
export class CouponRepository extends BaseRepository<Coupon> {
  ...
  //       ERROR_CODES.err_coupon_must_has_discount_amount_or_free_delivery,
  //     );
  //   }

  //   if (
  //     moment(createCouponDto.expired_at).isBefore(
  //       moment(createCouponDto.valid_from).format(this.formatDate),
  //       'day',
  //     )
  //   ) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_expired_at_is_before_valid_from_date,
  //     );
  //   }
  ...
  //   const couponCodeIsExists = await this.checkCodeIsExists(
  //     merchantId,
  //     coupon.branchId,
  //     coupon.code,
  //     id,
  ...
  //     moment(updateCouponDto.expired_at).isBefore(
  //       moment(updateCouponDto.valid_from).format(this.formatDate),
  //       'day',
  //     )
  //   ) {
  //     throw new BadRequestException(
  ...
  //       productsIds:
  //         Array.isArray(updateCouponDto?.productsIds) &&
  //         updateCouponDto?.productsIds?.length > 0
  ...
  //     _id: new mongoose.Types.ObjectId(checkCouponDto.clientId),
  //   });
  ...
  //   if (
  //     !coupon?.productsIds ||
  //     coupon?.productsIds.length == 0 ||
  //     !isProductCoupon
  //   ) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_is_not_match_product,
  //     );
  //   }

  //   if (coupon.orderType != checkCouponDto.orderType) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_order_type_not_matched,
  //     );
  //   }

  //   if (
  //     moment().isBefore(
  //       moment(coupon.valid_from).format(this.formatDate),
  //       'day',
  //     )
  //   ) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_valid_from_date_greater_than_now,
  //     );
  //   }

  //   if (
  //     moment().isAfter(moment(coupon.expired_at).format(this.formatDate), 'day')
  //   ) {
  //     throw new BadRequestException(ERROR_CODES.err_coupon_is_expired);
  //   }

  //   const countCouponUsedPerClient = await this.countCouponUsePerClient(
  //     coupon._id.toString(),
  //     checkCouponDto.clientId,
  //   );
  ...
  //   const countCouponUsedPerClients = await this.countCouponUsePerClients(
  //     coupon._id.toString(),
  //   );
  ...
  //   const isNewClient = await this.isNewClientUseCoupon(
  //     checkCouponDto.clientId,
  //   );
  //   if (client && coupon?.is_new_client && !isNewClient) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_must_be_for_new_client,
  //     );
  //   }

  //   const clientOrdersCount = await this.clientTotalOrdersCount(
  //     checkCouponDto.clientId,
  //   );
  //   if (
  //     client &&
  ...
  //   ) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_client_orders_count_less_than_current_count,
  //     );
  //   }
  ...
  //   const count = await this.orderRepository.countCouponUsePerClient(
  //     couponId,
  //     clientId,
  //   );
  //   return count;
  ...
  //     lowest_cart_price &&
  //     lowest_cart_price > 0 &&
  //     lowest_cart_price > totalItemsPrice
  //   ) {
  //     throw new BadRequestException(
  //       ERROR_CODES.err_coupon_order_items_prices_less_than_lowest_cart_price,
  //     );
  //   }
