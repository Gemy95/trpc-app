...
// import { ERROR_CODES } from '../../menu-template-product-group/dto/findAll-menu-template-product-group.dto';
...
export class MenuTemplateProductGroupRepository extends BaseRepository<MenuTemplateProductGroup> {
  constructor(
    @InjectModel(MenuTemplateProductGroup.name)
    private readonly nModel: Model<MenuTemplateProductGroup>,
  ) {
    super(nModel);
  }
  ...
  // ) {
  //   const menuTemplateProductGroup = await this.prepareMenuTemplateProductGroup(
  //     createMenuTemplateProductGroupDto,
  //   );

  //   // need to check if exists from before
  //   const menuTemplateProductGroupResponse = await this.create({
  ...
  //       ERROR_CODES.err_menu_template_product_group_not_found,
  //     );
  //   }
  ...
  //   const menuTemplateProductGroup = await this.getById(
  //     new mongoose.Types.ObjectId(menuTemplateProductGroupId),
  //     {},
  //   );
  //   if (!menuTemplateProductGroup) {
  ...
  //   menuTemplateProductGroup.name =
  //     createMenuTemplateProductGroupDto?.nameArabic;
  //   menuTemplateProductGroup.maximum =
  //     createMenuTemplateProductGroupDto?.maximum;
  //   menuTemplateProductGroup.minimum =
  //     createMenuTemplateProductGroupDto?.minimum;
  //   menuTemplateProductGroup.required =
  //     createMenuTemplateProductGroupDto?.required;
  //   menuTemplateProductGroup.status = createMenuTemplateProductGroupDto?.status;
  //   menuTemplateProductGroup.isDeleted = false;
  //   menuTemplateProductGroup.translation =
  //     createMenuTemplateProductGroupDto?.nameEnglish
  //       ? [
  //           {
  //             _lang: 'en',
  ...
  //         ]
  //       : undefined;
  //   menuTemplateProductGroup.options =
  //     createMenuTemplateProductGroupDto?.options?.map((option) => {
  //       return {
